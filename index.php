...
<body>
    <h1 align='center' style="margin: 15px; color:seagreen;font-weight: bold;font-family:'Times New Roman', Times, serif">AUTOMATED ELDORET EXPRESS INFORMATION MANAGEMENT SYSTEM</h1>
    <hr />
    <P align='center' style="font-weight: bold;color:orange;font-family:'Times New Roman', Times, serif">The BEST INFORMATION MANAGEMENT SYSTEM</P>
    <div>
