...
<style>
    body {
        background-image: url('../images/ELDO3.png');
...
<div class="admintitle">
    ...
    <h1 align='center' style="text-shadow: 0.1em 0.1em 0.15em #f9829b;">Welcome To Admin Dashboard</h1>
</div>
<div align="center" style="margin-top:240px;">
    <form style="position: center;color:lightblue;font-weight:bold;font-size:50px">
        <a href="download.php" class="btn-download">Download PDF</a><br><br>
        <a href="deletedata.php">Delete Data</a><br><br>
        <a href="deleteusers.php">Delete Courier</a><br><br>
    </form>
</div>
</body>
</html>