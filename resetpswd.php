...
<head>
    ...
    <style>
        body
        {
        background-image:url('images/ELDORET1.png');
...
<body>
    <h1 align='center' style="margin: 15px; color:green;font-weight: bold;font-family:'Times New Roman', Times, serif">AUTOMATED ELDORET EXPRESS INFORMATION MANAGEMENT SYSTEM</h1><hr/>
    <P align='center' style="font-weight: bold;color:yellow;font-family:'Times New Roman', Times, serif">The best courier Information management system</P>
