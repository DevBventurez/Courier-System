...
<head>
    ...
    <title>Order</title>
    <style>
        /* Add the following styles for circular profile image */
        td img {
            border-radius: 50%;
    ...
    <form action="editdata.php" method="POST" enctype="multipart/form-data">
        <div style="overflow-x:auto;">
            <table border="0px solid" style="margin-left: auto; margin-right:auto; margin-top:30px; font-weight:bold;border-spacing: 5px 15px;">
                ...
                <tr>
                    <th colspan="2">Courier</th><th colspan="2">RECEIVER</th>
                </tr>
                <tr>
                ...
                <td>Email:</td>
                <td><input type="text" name="semail" value="<?php echo $data['semail'];?>" required></td>
                <td>Email:</td>
                ...
                <tr>
                    ...
                    <td>Items Image:</td>
                    <td>
                        <!-- Display the image in a circular manner -->
                        <img src="<?php echo $data['image'];?>" alt="Profile Image">
                        <!-- Allow the user to update the image -->
                ...
                <tr>
                    ...
                    <td colspan="4" align="center">
                        <input type="submit" name="submit" value="Update" style="background-color: orange; border-radius: 15px; width: 140px; height: 50px;cursor:pointer;">
                    </td>
                </tr>
            </table>
        </div>   
